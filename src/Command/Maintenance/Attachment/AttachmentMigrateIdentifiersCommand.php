...
final class AttachmentMigrateIdentifiersCommand extends Command
{
    ...
    private function recreateAttachmentTable(): void
    {
        ...
        $this->connection->executeStatement('CREATE UNIQUE INDEX "UNIQ_795FD9BBD17F50A6" ON attachment (uuid)');
        $this->connection->executeStatement('CREATE UNIQUE INDEX "UNIQ_795FD9BB989D9B62" ON attachment (slug)');
    }
    ...
    private function recreateAttachmentLinkTable(): void
    {
        ...
        $this->connection->executeStatement('CREATE INDEX "IDX_CEDF8DCE464E68B" ON attachment_link (attachment_id)');
    }
