...
final class AttachmentMigrateIdentifiersCommand extends Command
{
    ...
    private function recreateAttachmentTable(): void
    {
        ...
        $this->connection->executeStatement('CREATE UNIQUE INDEX uniq_attachment_uuid ON attachment (uuid)');
        $this->connection->executeStatement('CREATE UNIQUE INDEX uniq_attachment_slug ON attachment (slug)');
    }
    ...
    private function recreateAttachmentLinkTable(): void
    {
        ...
        $this->connection->executeStatement('CREATE INDEX idx_attachment_link_attachment ON attachment_link (attachment_id)');
    }
